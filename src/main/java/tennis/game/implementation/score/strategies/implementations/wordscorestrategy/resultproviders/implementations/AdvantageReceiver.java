...
public class AdvantageReceiver implements IResultProvider {
    ...
    public AdvantageReceiver() {}

    public AdvantageReceiver(final ITennisGamePlayersAndScore gamePlayers,
    ...
    public ITennisResult getResult() {
        if (gamePlayers.receiverHasAdvantage())
            return new TennisResult("Advantage " + gamePlayers.getReceiver(), "");
